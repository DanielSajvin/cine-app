...
import gsap from "gsap"; // Importar GSAP para las animaciones
import "../styles/NotFound.css"; // Importar el CSS
  ...
  return (
    <>
      ...
      <div class="content">
        ...
        <p>
          Sabemos que da miedo, pero no se puede encontrar la página a la que
          intentas acceder. Tal vez solo fue un error o un mal sueño?
        </p>
      </div>
    </>
  );
